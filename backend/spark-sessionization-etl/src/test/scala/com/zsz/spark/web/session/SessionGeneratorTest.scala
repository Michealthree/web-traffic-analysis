...
import com.zsz.parser.dataobject.{EventDataObject, HeartbeatDataObject, McDataObject, PvDataObject}
import com.zsz.parser.dataobject.dim.{AdInfo, ReferrerInfo, SiteResourceInfo}
