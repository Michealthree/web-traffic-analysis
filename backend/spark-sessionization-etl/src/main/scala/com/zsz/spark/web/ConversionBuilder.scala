...
import com.zsz.parser.dataobject.{EventDataObject, TargetPageDataObject}
import com.zsz.web.{Conversion, ConversionType}
...
trait ConversionBuilder {
  ...
  import com.zsz.parser.utils.ParserUtils._
