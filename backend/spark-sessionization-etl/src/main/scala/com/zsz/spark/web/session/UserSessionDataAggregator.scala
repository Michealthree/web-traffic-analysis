package com.zsz.spark.web.session

import com.zsz.parser.dataobject._
import com.zsz.parser.dataobject.dim.TargetPageInfo
import com.zsz.spark.web.external.UserVisitInfo
import com.zsz.spark.web.{AvroRecordBuilder, CombinedId, ConversionBuilder}
import com.zsz.web.{Conversion, Heartbeat, MouseClick, PageView, Session}
...
class UserSessionDataAggregator(
  ...
  import com.zsz.spark.web.RichCollection._
