...
import com.zsz.parser.dataobject.{BaseDataObject, HeartbeatDataObject, McDataObject, PvDataObject}
import com.zsz.web.{Conversion, PageView, Session, Heartbeat, MouseClick}
