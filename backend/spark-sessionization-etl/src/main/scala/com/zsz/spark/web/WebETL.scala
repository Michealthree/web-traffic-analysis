...
import com.zsz.spark.web.external.{HBaseSnapshotAdmin, HbaseConnectionFactory}
...
--class com.zsz.spark.web.WebETL \
--driver-memory 512M \
--executor-memory 1G \
...
--conf spark.driver.extraJavaOptions="-Dweb.metadata.mongodbAddr=192.168.101.4 -Dweb.etl.hbase.zk.quorums=master" \
--conf spark.executor.extraJavaOptions="-Dweb.metadata.mongodbAddr=192.168.101.4 -Dweb.etl.hbase.zk.quorums=master -Dcom.sun.management.jmxremote.port=1119 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false" \
/home/hadoop-zsz/traffic-analysis/jars/spark-sessionization-etl-1.0-SNAPSHOT-jar-with-dependencies.jar prod
  */
object WebETL {
  def main(args: Array[String]): Unit = {
    ...
    val outputBaseDir = conf.getOption("spark.web.etl.outputBaseDir")
      .getOrElse("hdfs://master:9999/user/hadoop-zsz/traffic-analysis/web")
    //日志的时间
